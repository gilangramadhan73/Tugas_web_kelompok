...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg shadow p-3 bottom-under ml-2 mr-2 mt-2 bg-light rounded navbar-light bg-light">
        <a class="navbar-brand" href="#"><strong class="text-primary">anjayyy </strong><strong class="text-dark">Arisan</strong></a>
            ...
            <div class="row">
                ...
                <div class="card ml-5 mt-5" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text">ArisanOnlineKita212@gmail.com</p>
                ...
                <div class="card ml-5 mt-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">0895-6357-29348</p>
